...
public class OrderControllerTest {
    ...
    @RegisterExtension
    static WireMockExtension wiredMockExtension = WireMockExtension.newInstance()
    ...
    private void getPaymentResponse() throws IOException {
        wiredMockExtension.stubFor(WireMock.get("/payments/.*") // urlMatching("/payments/.*")
    ...
    private void doPayment() {
        wiredMockExtension.stubFor(WireMock.post("/payments") // urleq
                .willReturn(WireMock.aResponse()
                        .withStatus(HttpStatus.OK.value())
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                )
    ...
    private void getProductResponse() throws IOException {
        ...
        wiredMockExtension.stubFor(WireMock.get("/products/1")
                .willReturn(WireMock.aResponse().
                        withStatus(HttpStatus.OK.value())
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody(StreamUtils.copyToString(
    ...
    private void reduceQuantity() {
        wiredMockExtension.stubFor(WireMock.put("/product/reduceQuantity")
                .willReturn(WireMock.aResponse()
                        .withStatus(HttpStatus.OK.value())
                        .withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                )
